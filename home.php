...
if ( isset( $cat ) ) { $b_cat = "<a href=\"".HOME."home.php?cat=$cat\">".ucwords($cat)."</a>"; }
if ( isset( $subcat ) ) {$b_subcat = "<a href=\"".HOME."home.php?cat=$cat&subcat=$subcat\">$subcat</a>";}
if ($subcat1) {$b_subcat1 = "<a href=\"".HOME."home.php?cat=$cat&subcat=$subcat&subcat1=$subcat1\">$subcat1</a>";}
if ($subcat2) {$b_subcat2 = "<a href=\"".HOME."home.php?cat=$cat&subcat=$subcat&subcat1=$subcat1&subcat2=$subcat2\">$subcat2</a>";}
...
if ( isset( $result) ) {
	foreach ( $result as $row ) {
		...
		if ($next=="subcat")  {if ($row->subcat)  {$categories[] = "<a href=\"".HOME."home.php?cat=$cat&subcat=$row->subcat\">$row->subcat</a><br>\n";}}
		if ($next=="subcat1") {if ($row->subcat1) {$categories[] = "<a href=\"".HOME."home.php?cat=$cat&subcat=$subcat&subcat1=$row->subcat1\">$row->subcat1</a><br>\n";}}
		if ($next=="subcat2") {if ($row->subcat2) {$categories[] = "<a href=\"".HOME."home.php?cat=$cat&subcat=$subcat&subcat1=$subcat1&subcat2=$row->subcat2\">$row->subcat2</a><br>\n";}}
	}
}
